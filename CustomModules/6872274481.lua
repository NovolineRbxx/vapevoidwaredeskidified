	...
	task.spawn(function()
		pcall(function()
			if not isfile("vape/Profiles/bedwarsdata.txt") then 
				local commit = "main"
				for i,v in pairs(game:HttpGet("https://github.com/GalaxyGuardDev/GalaxyGuardRoblox"):split("\n")) do 
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/GalaxyGuardDev/GalaxyGuardRoblox/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/GalaxyGuardDev/GalaxyGuardRoblox/"..commit.."/CustomModules/bedwarsdata", true)
